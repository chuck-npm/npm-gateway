...
return ['provider'=>'wasabi','endpoint'=>$env('WASABI_ENDPOINT'),'region'=>$env('WASABI_REGION'),'container'=>$env('WASABI_BUCKET'),'access_key'=>$env('WASABI_ACCESS_KEY'),'secret_key'=>$env('WASABI_SECRET_KEY'),'attachment_prefix'=>$env('WASABI_COMPANY_NOTICE_ATTACHMENTS_PREFIX'),'image_prefix'=>$env('WASABI_COMPANY_NOTICE_IMAGES_PREFIX'),'test_prefix'=>$testPrefix!==''?$testPrefix:'company_notices/test/','environment'=>strtolower($env('APP_ENV')?:'production'),'credit_card_receipts_prefix'=>$env('WASABI_CREDIT_CARD_RECEIPTS_PREFIX'),'credit_card_receipts_test_prefix'=>$env('WASABI_CREDIT_CARD_RECEIPTS_TEST_PREFIX'),'credit_card_receipt_real_storage_testing'=>$env('CREDIT_CARD_RECEIPT_REAL_STORAGE_TESTING')];
