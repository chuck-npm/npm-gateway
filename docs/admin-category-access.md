...
The matrix includes Application Reviews as an independent category. Administrators may grant it without Operations, and no migration or backfill grants it automatically.
