...
{
 /** @param list<array{label:string,value:string,emphasized?:bool}> $summaryRows @param list<array{title:string,body:string}> $sections */
 public function __construct(
  ...
  foreach($sections as $section)if(!is_array($section)||array_keys($section)!==['title','body']||!is_string($section['title'])||!is_string($section['body']))throw new \InvalidArgumentException('Invalid Gateway email section.');
 }
}
