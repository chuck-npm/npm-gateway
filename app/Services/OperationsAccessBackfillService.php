...
final class OperationsAccessBackfillService
{
 ...
 {
  if(array_keys($this->categories)!==['operations','human-resources','company-notices','finance','marketing','admin','credit-cards'])throw new \RuntimeException('The approved Operations category allowlist is unavailable or invalid.');
