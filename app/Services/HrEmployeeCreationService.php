...
final class HrEmployeeCreationService
{
    ...
    public function create(array $input,AuthenticatedUser $actor):HrEmployeeCreationResult
    {
        ...
        try{
            ...
            try{
                ...
                $this->audits->record('hr.employee_created',$actor->id,$employeeId,$employeePublic,'HR employee, assignment, and Gateway account created.',$safe,$timestamp);$this->transaction->commit();
            }catch(\Throwable $e){$this->transaction->rollback();throw $e;}
