...
final class AuthenticationService implements AuthenticationServiceInterface
{
 ...
 public function authenticate(LoginRequest $request,ClientContext $context):AuthenticationResult
 {
  ...
  try {
   ...
   $user=new AuthenticatedUser((int)$record['id'],(int)$record['employee_id'],(string)$record['public_id'],(string)$record['employee_public_id'],(string)$record['username'],trim($record['first_name'].' '.$record['last_name']),(string)($record['job_title']??''));
