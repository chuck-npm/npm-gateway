...
final class GatewayStorageService
{
 ...
 public function available(array $object):bool{try{return $this->adapter->exists((string)$object['provider_container'],(string)$object['object_key']);}catch(\Throwable){return false;}}
