...
final class SessionService implements SessionServiceInterface
{
 ...
 private function identity(array $r):AuthenticatedUser{return new AuthenticatedUser((int)$r['id'],(int)$r['employee_id'],(string)$r['public_id'],(string)$r['employee_public_id'],(string)$r['username'],trim($r['first_name'].' '.$r['last_name']),(string)($r['job_title']??''),(string)($r['employee_class']??''));}
