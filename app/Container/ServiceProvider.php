...
use NpmGateway\Repositories\ZillowRepository;
...
use NpmGateway\Services\{ZillowService,ZillowWorkbookParser,ZillowPhoneNormalizer,ZillowReportCriteriaFactory};
...
final class ServiceProvider
{
    ...
    public static function build(array $application): Container
    {
        ...
        $container->set(ZillowRepository::class,static fn(Container$c):ZillowRepository=>new ZillowRepository($c->get(mysqli::class)));
        $container->set(ZillowPhoneNormalizer::class,static fn():ZillowPhoneNormalizer=>new ZillowPhoneNormalizer());
        $container->set(ZillowWorkbookParser::class,static fn(Container$c):ZillowWorkbookParser=>new ZillowWorkbookParser($c->get(ZillowPhoneNormalizer::class)));
        $container->set(ZillowReportCriteriaFactory::class,static fn():ZillowReportCriteriaFactory=>new ZillowReportCriteriaFactory());
        $container->set(ZillowService::class,static fn(Container$c):ZillowService=>new ZillowService($c->get(ZillowWorkbookParser::class),$c->get(ZillowRepository::class),$c->get(InitializationTransactionInterface::class),$c->get(PublicIdGenerator::class),$c->get(ClockInterface::class),$c->get(AuditService::class),$c->get(ZillowReportCriteriaFactory::class)));
        ...
        $container->set(CallLogService::class,static fn(Container$c):CallLogService=>new CallLogService($c->get(CallLogWorkbookParser::class),$c->get(CallLogRepository::class),$c->get(InitializationTransactionInterface::class),$c->get(PublicIdGenerator::class),$c->get(ClockInterface::class),$c->get(AuditService::class),$c->get(CallLogFilterCriteriaFactory::class)));
        $container->set(CallLogReportRepository::class,static fn(Container$c):CallLogReportRepository=>new CallLogReportRepository($c->get(mysqli::class)));
        $container->set(CallLogReportDateRangeFactory::class,static fn():CallLogReportDateRangeFactory=>new CallLogReportDateRangeFactory());
        $container->set(CallLogReportService::class,static fn(Container$c):CallLogReportService=>new CallLogReportService($c->get(CallLogReportRepository::class),$c->get(CallLogReportDateRangeFactory::class)));
