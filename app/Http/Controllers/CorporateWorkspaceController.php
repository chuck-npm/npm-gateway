...
final class CorporateWorkspaceController
{
 ...
 public function finance(AuthenticatedRequestContext $context):Response{if(!$this->allowed($context,'finance'))return new Response(403,'Forbidden');$cards=[];return $this->render($context,'corporate/finance/index.php',compact('cards'));}
