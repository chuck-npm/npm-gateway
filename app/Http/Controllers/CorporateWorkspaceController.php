...
final class CorporateWorkspaceController
{
 ...
 public function finance(AuthenticatedRequestContext $context):Response{if(!$this->allowed($context,'finance'))return new Response(403,'Forbidden');$cards=[new ToolCard('credit-card-purchases','Credit Card Purchases','Review company credit card activity, receipts, and missing documentation.','Finance','Module planned',null,false,10,'Planned','Credit Card Purchases, Module planned',null)];return $this->render($context,'corporate/finance/index.php',compact('cards'));}
