...
final class DashboardController
{
 ...
 public function index(AuthenticatedRequestContext $context):Response{$user=$context->user;$csrfToken=$this->csrf->token();$home=$this->homes->forRequest($context);ob_start();require $this->views.'/dashboard.php';return new Response(200,(string)ob_get_clean());}
}
