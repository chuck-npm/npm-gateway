...
final class CommunityActionWorkspaceTest extends TestCase
{
    ...
    private const SEGMENTS = ['application-reviews','credit-card-purchases','rm-corrections','renovation-requests','request-appliances','appliance-distribution','hvac-service-requests','supply-orders','eviction-checks','rm-audits'];
    ...
    public function testProviderIsTheOrderedAuthoritativePlannedCatalog(): void
    {
        ...
        self::assertSame([true,true,true,false,false,false,false,true,false,true], array_column($actions, 'implemented'));
