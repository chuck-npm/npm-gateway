...
final class ApplicationReviewsCategoryTest extends TestCase
{
 public function testCategoryConfigurationAndMigrationContract():void
 {
  ...
  self::assertSame(['operations','human-resources','company-notices','application-reviews','rm-corrections','rm-audit','finance','marketing','admin','credit-cards'],array_keys($config['categories']));
