...
use NpmGateway\Http\Controllers\OperationsRmAuditPdfController;
...
use NpmGateway\Services\{ApartmentsService,CallLogAccessPolicy,CallLogService,CallLogReportService};
...
$operationsOverview=new OperationsOverviewController($container->get(CorporateAccessService::class),$container->get(OperationsRmCorrectionOverviewService::class),$container->get(OperationsRmAuditOverviewService::class),$container->get(ClockInterface::class),$container->get(CorporateToolsProviderInterface::class),$csrf,$views);
$rmAudits=new \NpmGateway\Http\Controllers\RmAuditController($container->get(\NpmGateway\Services\CommunityActionContextResolver::class),$container->get(\NpmGateway\Services\RmAuditQueryService::class),$container->get(\NpmGateway\Services\RmAuditService::class),$container->get(CorporateToolsProviderInterface::class),$csrf,new FlashSession($_SESSION),$views);
